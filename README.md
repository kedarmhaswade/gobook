...
This is my fork of the book repo. It is an unusual fork in that it does not fork from the original. That is mainly because I wanted to get a solid base and then keep all my go files at one place (e.g. exercises from the book).
